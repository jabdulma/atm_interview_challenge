            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1 }}>
                ...
                <Grid xs={5}>
                    <Stack>
                        ...
                        <Button sx={{marginTop:'20px'}} onClick={getCashButton} variant="contained" size="large">Get Cash</Button>
                ...
                <Grid xs={10} container sx={{paddingTop: '40px'}}>
                    <Grid xs={4}>
                        <Button variant="contained" sx={{height: '100px', width:'100px'}} onClick={() => {quickCashButton(20)}} size="large"><h2>$20</h2></Button>
                    </Grid>
                    <Grid xs={4}>
                        <Button variant="contained" sx={{height: '100px', width:'100px'}} onClick={() => {quickCashButton(50)}} size="large"><h2>$50</h2></Button>
                    </Grid>
                    <Grid xs={4}>
                        <Button variant="contained" sx={{height: '100px', width:'100px'}}  onClick={() => {quickCashButton(100)}} size="large"><h2>$100</h2></Button>
                    </Grid>
                </Grid>
                <Grid xs={1}></Grid>
            </Grid>
